                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative">
                    ...
                    <div className="w-full max-w-[420px] flex flex-col gap-8">
                        <div className="text-left">
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Acesse sua conta</h1>
                            <p className="text-gray-500 dark:text-gray-400 text-base">Bem-vindo de volta ao seu painel de controle.</p>
                        </div>
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleLogin}>
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-200 ml-1" htmlFor="email">E-mail ou Usuário</label>
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-14 pl-12 pr-4 bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-base placeholder:text-gray-400 dark:text-white transition-all"
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-14 pl-12 pr-12 bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-base placeholder:text-gray-400 dark:text-white transition-all"
                                        placeholder="••••••••"
                                        required
                                    />
                                    <button type="button" className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white transition-colors cursor-pointer">
                        ...
                        <div className="relative flex py-2 items-center">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-400 text-sm">Novo por aqui?</span>
                            <div className="flex-grow border-t border-gray-200 dark:border-gray-700"></div>
                        </div>
